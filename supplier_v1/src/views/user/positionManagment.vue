...
<template>
  <!-- 职位管理页面 -->
  <div class="positionManagment" @click='isShow=false'>
    <!--  新增职位弹窗 -->
    <div id="postionid" v-show="isShow">
      <div class="newPosition"  @click.stop>
    ...
    <div class="positionManagmentTitle clearfix">
      <h4 class="fl">职位管理</h4>
      <div class="fr">
        <input type="button" value="新增" @click.stop="addShow()" />
    ...
    <div class="positionContent">
      <template>
        ...
        >
          <el-table-column label="序号" prop="index" type="index" width="100px" align="center" >
          ...
          <el-table-column label="操作" align="center">
            <template slot-scope="scope">
              <input
                ...
                @click.stop="postionTitle='编辑职位管理',handleClick(scope.row)"
              />
            </template>
          </el-table-column>
        </el-table>
           ...
           children: [
            {
              id: 81,
              label: "发布供应信息",
              url: "/issueProvisionInfo"
            },
            {
              id: 82,
              label: "供应信息详情",
              url: "/provisionInfoDetails"
            }
          ]
        },
        {
