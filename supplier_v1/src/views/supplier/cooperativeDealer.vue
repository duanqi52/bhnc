<template>
  <!-- 合作的供应商 -->
  <div id="bhncCooperativeSupplier">
      ...
      <!-- <div class="header_search_wei">
        <div class="tangchu">
          <el-collapse-transition>
            <div v-show="show3" style="padding: 13px; border: 1px solid #4ca5e9;">
              <div>
                <p class="region">地区</p>
                <el-cascader
              ...
              <div class="but_que">
                ...
                <el-button @click="show3 = !show3;scopeSearch()">确定</el-button>
              </div>
            </div>
          </el-collapse-transition>
        </div>
      ...
      >
        ...
        <el-table-column label="操作" align="see">
          <template slot-scope="scope">
            ...
            <button
              class="seedetails"
              @click="$router.push('/supplierDetail?index=1&id='+scope.row.id)"
            >查看详情</button>
          </template>
        </el-table-column>
      </el-table>
...
export default {
  ...
  methods: {
    ...
    search(page, size) {
      ...
      this.searchMap.scope = JSON.stringify(this.checkedCities);
