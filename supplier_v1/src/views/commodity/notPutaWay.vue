  ...
  <div id="mian_nav">
    <div class="top_nava">
      <el-menu :default-active="activeIndex" class="el-menu-demo" mode="horizontal" @select="handleSelect">
        <el-menu-item index="1">大市场</el-menu-item>
        <el-menu-item index="2">非公开商品</el-menu-item>
      </el-menu>


<div id="main_01">
      <el-tabs v-model="activeName" @tab-click="handleClick">
          <el-tab-pane label="已上架(2)" name="first">
           <div style="height: 55px;">
            <el-row :gutter="24" >
              ...
              <el-button  style="color: #FFFFFF;background-color: #FC9263;">上架</el-button>
              </div>
              </el-col>
              <el-col :span="3" ><div class="grid-content bg-purple" style="position: relative;right: 55px;">
              <el-button style="color: #FC9263;background-color: #FFFFFF;">永久删除</el-button>
              </div>
              </el-col>
              <el-col :span="2" ><div class="grid-content bg-purple" style="position: relative;left: 560px;">
              ...
              <el-col :span="1" :push="1"><div class="grid-content bg-purple">
               <el-input v-model="input" placeholder="商品标题 / 型号" clearable style="width: 220px;position: relative;left: 480px;"></el-input>
              </div>
              </el-col>
              <el-col :span="1" :push="11"><div class="grid-content bg-purple" style="position: relative;right: 10px;">
