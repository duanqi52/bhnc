...
export default {
  metaInfo: {
    title: "笔海弄潮现货大厅，汇聚中国范围内制笔源头供应商的现货产品", // set a title
    meta: [
      {
        // set meta
        name: "keyWords",
        content:
          "库存、现货、备货、圆珠笔、中性笔、签字笔、钢笔、金属笔、塑料笔、记号笔、铅笔"
      },
      {
        name: "description",
        content:
          "笔海弄潮收罗中国范围内的制笔厂家的常年备货库存产品，共享给全球制笔行业采购商，产品范围有中性笔、圆珠笔、钢笔、宝珠笔、记号笔、马克笔、铅笔、制笔机械设备、制笔行业各类零部件等。"
      }
    ]
  },
  data() {
  ...
  created() {
    ...
    if (!ids) {
      if (this.$route.query.input) this.input = this.$route.query.input;
